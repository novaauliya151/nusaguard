...
export default function Home() {
  ...
  return <div className={`${large?"large":""} ${contrast?"contrast":""}`}>
    <header><a className="brand" href="#top"><span>NG</span>NusaGuard</a><nav><a href="#analisis">Analisis</a><a href="#edukasi">Kenali modus</a><a href="#privasi">Privasi</a><a href="/login">Masuk</a></nav><div className="access"><button onClick={()=>setLarge(v=>!v)} aria-pressed={large}>A+</button><button onClick={()=>setContrast(v=>!v)} aria-pressed={contrast}>◐</button></div></header>
    <main id="top">
